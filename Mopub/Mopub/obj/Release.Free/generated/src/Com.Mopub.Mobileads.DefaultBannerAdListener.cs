...
namespace Com.Mopub.Mobileads {
	...
	public partial class DefaultBannerAdListener : global::Java.Lang.Object, global::Com.Mopub.Mobileads.MoPubView.IBannerAdListener {
		...
		[Register (".ctor", "()V", "")]
		public DefaultBannerAdListener () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Mopub.Mobileads.DefaultBannerAdListener __this = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mobileads.DefaultBannerAdListener> (native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual void OnBannerClicked (global::Com.Mopub.Mobileads.MoPubView p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_onBannerClicked_Lcom_mopub_mobileads_MoPubView_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnBannerCollapsed (global::Com.Mopub.Mobileads.MoPubView p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_onBannerCollapsed_Lcom_mopub_mobileads_MoPubView_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnBannerExpanded (global::Com.Mopub.Mobileads.MoPubView p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_onBannerExpanded_Lcom_mopub_mobileads_MoPubView_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnBannerFailed (global::Com.Mopub.Mobileads.MoPubView p0, global::Com.Mopub.Mobileads.MoPubErrorCode p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_onBannerFailed_Lcom_mopub_mobileads_MoPubView_Lcom_mopub_mobileads_MoPubErrorCode_, new JValue (p0), new JValue (p1));
		}
...
#pragma warning restore 0169
		...
		public virtual void OnBannerLoaded (global::Com.Mopub.Mobileads.MoPubView p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_onBannerLoaded_Lcom_mopub_mobileads_MoPubView_, new JValue (p0));
		}
